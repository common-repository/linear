 ...
 */
function linear_listings_get_block_metadata() {
 ...
 */
function linear_listings_get_block_config() {
 ...
 */
function linear_listings_get_current_locale() {
    global $TRP_LANGUAGE;
 ...
 */
function linear_listings_get_rest_url(){
...
function get_setting_value( $key = null ){
    $default = '';
    ...
    $settings = get_option( 'linear_settings' );
